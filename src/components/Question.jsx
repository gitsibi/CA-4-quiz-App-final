...
export default function Question() {
  ...
  // Gets the current question based on the currentIndex.
      ...
      <div>
        <div className={`navbar ${darkMode ? 'darken' : ''}`}>
          ...
          <div className="lightNdark">
            ...
            {/* {darkModeText}: This is a placeholder for a variable in JavaScript. The curly braces {} are used to embed JavaScript 
            expressions in JSX (the syntax used by React). Here, darkModeText is a variable 
            that holds the text to be displayed on the button (either "Dark Mode" or "Light Mode" depending on the current theme). */}
          </div>
        </div>
        {
          currentQuestion ? (
...
{/* <Answer score={currentScore} onRestart={handleRestart} /> */}
//  Renders the Answer component, passing the current score and the handleRestart function as props.